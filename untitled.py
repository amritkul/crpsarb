...
for marketName in fetcher.marketData['return']['markets']:
    try:
        ...
        buymkt = fetcher.getDepth(marketid)
        ...
        if fetcher.marketData['return']['markets'][marketName]['secondarycode'] == 'LTC':
            ltcMarkets.append({'market': marketName, 'hi_buy': hi_buy,'hi_buyq': hi_buyq, 'lo_sell': lo_sell, 'lo_sellq': lo_sellq, 'sn': sn, 'marketid': marketid})
        if fetcher.marketData['return']['markets'][marketName]['secondarycode'] == 'BTC':
            btcMarkets.append({'market': marketName, 'hi_buy': hi_buy,'hi_buyq': hi_buyq, 'lo_sell': lo_sell, 'lo_sellq': lo_sellq, 'sn': sn, 'marketid': marketid})
    except:
        pass
